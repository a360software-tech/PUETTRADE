...
from market_data.application.dto import CandleItemResponse, CandleQuery, CandlesResponse, Resolution
from market_data.application.ports import StreamingMarketDataPort
...
from shared.errors.base import IntegrationError, NotAuthenticatedError

_CACHE_TTL_SECONDS = 10.0
_candle_cache: dict[tuple[str, str, int, str | None, str | None, str | None], tuple[float, CandlesResponse]] = {}


class MarketHistoryService:
    def __init__(self, settings: Settings, repository: CandleRepository) -> None:
...
def reseed_buffer_from_persistence(
    ...
    _seed_stream_buffer_from_history(epic=epic, resolution=resolution, candles=candles)
    return candles
